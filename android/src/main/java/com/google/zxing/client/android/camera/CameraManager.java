...
//                                        rect.width(), rect.height(), false);
        ...
        Log.d("GJF", "width --1920--" + width);
        Log.d("GJF", "height --1080--" + height);

        Log.d("GJF", "point --x-1440-" + point.x);
        Log.d("GJF", "point --Y-2392-" + point.y);
        if (point.x < point.y) {
            ...
            Log.d("GJF", "point --rect.left-202=" +rect.left);
            Log.d("GJF", "point --rect.top-688=" +rect.top);
            Log.d("GJF", "point --rect.width-675=" +rect.width());
            Log.d("GJF", "point --rect.left-542=" +rect.height());
